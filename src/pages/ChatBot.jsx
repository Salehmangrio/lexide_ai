...
How can I assist you today?`,
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // Read the entire stream and collect full response
      ...
      // Only one update → full message appears instantly
      setMessages(prev => [...prev, { role: "assistant", content: fullResponse.trim() || "No response." }]);
